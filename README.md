# gittish-core-protocol-organization-transfer

This package defines the service interface that is responsible for transferring
existing organizations to different owners.

The service supports the following use cases

* transfer an existing organization to a specified new owner
...
```
cd <WORKSPACE_ROOT>/gittish-core-protocol-organization-transfer
./configure
```
